...
class OrderTableServiceTest {
    ...
    @DisplayName("주문 테이블의 이름이 올바르지 않으면 생성할 수 없다.")
    @NullAndEmptySource
    @ParameterizedTest
    ...
    @DisplayName("주문 테이블에 매장내주문 고객님이 착석한다")
    @Test
    void sit() {
    ...
    @DisplayName("주문 테이블을 초기화 할 수 있다.")
    @Test
    void clear() {
    ...
    @DisplayName("완료되지 않은 주문이 있는 주문 테이블은 초기화할 수 없다.")
    @Test
    ...
    @DisplayName("착석한 손님 수를 변경할 수 있다.")
    @Test
    ...
    @DisplayName("착석한 손님 수가 올바르지 않으면 변경할 수 없다.")
    @ValueSource(ints = -1)
    @ParameterizedTest
    ...
    @DisplayName("빈 테이블은 착석한 손님 수를 변경할 수 없다.")
    @Test
