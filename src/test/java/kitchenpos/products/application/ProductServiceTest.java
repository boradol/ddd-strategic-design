...
class ProductServiceTest {
    ...
    void setUp() {
        ...
        profanityDetectionClient = new FakeProductProfanityDetectionClient();
        productService = new ProductService(productRepository, menuRepository, profanityDetectionClient);
    }
