...
class MenuServiceTest {
    ...
    private ProfanityDetectionClient profanityDetectionClient;
    ...
    void setUp() {
        ...
        profanityDetectionClient = new FakeMenuProfanityDetectionClient();
        menuService = new MenuService(menuRepository, menuGroupRepository, productRepository, profanityDetectionClient);
