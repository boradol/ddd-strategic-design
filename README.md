...
| 한글 용어 | 영어 용어        | 설명                                      |
|-------|--------------|-----------------------------------------|
| 상품    | Product      | 메뉴를 이루는 품목을 의미한다. 메뉴는 하나 이상의 상품으로 구성된다. |
...
| 한글 용어  | 영어 용어      | 설명              |
|--------|------------|-----------------|
| 메뉴그룹   | Menu Group | 메뉴의 상위그룹을 의미한다. |
...
| 한글 용어   | 영어 용어        | 설명                                        |
|---------|--------------|-------------------------------------------|
| 메뉴      | Menu         | 한 개 이상의 상품으로 구성된다. 메뉴는 하나의 메뉴그룹을 가진다.     |
...
| 배달      | Delivery         | 고객이 주문한 음식을 배달로 보내는 주문 유형이다.                                                                           |
